...
export const getAllBookings = (accessToken, apiKey) =>
  apiRequest("/holidaze/bookings", "GET", accessToken, apiKey);
export const getBookingById = (id, accessToken, apiKey) =>
  apiRequest(`/holidaze/bookings/${id}`, "GET", accessToken, apiKey);
export const createBooking = (bookingData, accessToken, apiKey) =>
  apiRequest("/holidaze/bookings", "POST", accessToken, apiKey, bookingData);
