...
export const getAllProfiles = (accessToken, apiKey) =>
  apiRequest("/holidaze/profiles", "GET", accessToken, apiKey);
export const getProfileByName = (name, accessToken, apiKey) =>
  apiRequest(`/holidaze/profiles/${name}`, "GET", accessToken, apiKey);
...
export const getProfileBookings = (name, accessToken, apiKey) =>
  apiRequest(`/holidaze/profiles/${name}/bookings`, "GET", accessToken, apiKey);
export const getProfileVenues = (name, accessToken, apiKey) =>
  apiRequest(`/holidaze/profiles/${name}/venues`, "GET", accessToken, apiKey);
